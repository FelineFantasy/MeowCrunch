...
def main():
    ...
    if day > 90:
        ...
        if quality >= 80:
            ...
            print("Превосходный результат! Вы собрали идеальные золотистые хрустяшки.")
            print(f"Вы получили бонусные монеты и признание. Всего монет: {final_money}")
        else:
            print("Качество хрустяшек среднее или низкое. Урожай отправлен на конвейер по обычной цене.")
